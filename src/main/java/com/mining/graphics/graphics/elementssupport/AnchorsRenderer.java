...
public class AnchorsRenderer {
    private static AnchorsExcavation anchors;

    public AnchorsRenderer() {
    ...
    private static final double LENGTH_BACK_TIP = 0.08;         //Длина заднего наконечника
    ...
    public static void drawExpansionAnchor(Graphics2D g, int x1, int y1, int x2, int y2) {
        ...
        //Анкер
        g.drawRect(-ledgeAnchor, -anchorDiameter / 2, anchorLength, anchorDiameter);
        //Опорная плита
        ...
        g.drawRect(anchorLength - ledgeAnchor, -diameterTip / 2, lengthBackTip, diameterTip);
