...
//        yIntersectionWall23 = calculateIntersectionWallY(width2, b3, alpha2Rad, alpha3Rad);
//        yi2sc = (int) (yIntersectionWall23 * scaleInt);

//        xIntersectionWall34 = calculateIntersectionWallX(b3, width4, alpha3Rad, alpha4Rad);
//        xi3sc = (int) (xIntersectionWall34 * scaleInt);
//        yIntersectionWall34 = calculateIntersectionWallY(b3, width4, alpha3Rad, alpha4Rad);
//        yi3sc = (int) (yIntersectionWall34 * scaleInt);

//        xIntersectionWall41 = calculateIntersectionWallX(width4, b1, alpha4Rad, alpha1Rad);
//        xi4sc = (int) (xIntersectionWall41 * scaleInt);
//        yIntersectionWall41 = calculateIntersectionWallY(width4, b1, alpha4Rad, alpha1Rad);
//        yi4sc = (int) (yIntersectionWall41 * scaleInt);

//        xIntersectionWall31 = calculateIntersectionWallX(b3, b1, alpha3Rad, alpha1Rad);
//        xi33sc = (int) (xIntersectionWall31 * scaleInt);
//        yIntersectionWall31 = calculateIntersectionWallY(b3, b1, alpha3Rad, alpha1Rad);
...
//    }
    ...
    /**
     * Это метод масштабирования параметра.
     */
