...
public class ServiceMaterialSupportIntersection {
    ...
    public static double calculateAreaAnchorageAdjacentExcavation(double widthAdjacent, double heightAdjacent, double formIndicationAdjacent, double increasedWidth,
                                                                  double increasedHeight, double yPointIntrsectionExcavation, double yStartRounding,
                                                                  double distanceLowerAnchor) {
    ...
    public static double calculateAreaAnchorageIntersectionCenter(double increasedWidthAdjacentExcavation, double increasedWidthMainExcavation,
                                                                  double increasedHeightMainExcavation, double formIndicationIntersection, double distanceLowerAnchor) {
