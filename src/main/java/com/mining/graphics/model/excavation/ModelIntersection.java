...
public class ModelIntersection {
    ...
    private int azimuthDegrees1 = 20, azimuthDegrees2 = 90, azimuthDegrees3 = 240, azimuthDegrees4 = 270;

    // @formatter:off
    ModelIntersection(double width1, double height1, double length1, double formIndication1, int azimuthDegrees1,
