...
public class ModelIntersection {
    ...
    private double b2 = 3.0; //ширина выработки 2
    private double b3 = 5.0; //ширина выработки 3
    ...
    private int alpha3 = 320; //угол поворота оси выработки 3 относительно севера (от 90 до 360)
    private double L1 = 10.0; //длина выработки 1
    private double L2 = 10.0; //длина выработки 2
    private double L3 = 10.0; //длина выработки 3
